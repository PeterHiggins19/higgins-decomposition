...
*Status: abstract approved (2026-06-15); full paper assembled and compiling; submission gated on the
collective review + Peter's post. The `latex/` source is the working copy used to produce the arXiv PDF —
it is the reproducibility artifact, not a second publication.*
