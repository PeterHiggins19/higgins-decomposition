...
|---|---|---|---|
| 1 | **Exactness** — read a composition losslessly | ✅ done (T1) | quaternion S³ at D=4; tiling to **D=10⁶** at the IEEE floor (`cnq_tiling_highd`); every run reports its reconstruction error |
