...
1. **Stale `.git/index.lock`** (assistant-created 2026-06-18 11:38; cannot be removed from the sandbox).
   Delete it before any git op on this copy: `del .git\index.lock`.
