...
## 2 · Develop the device (with Matthew Wehner)
Matthew brings the two competencies this needs: compositional-data chemostratigraphy (wavelet + CoDa, Wehner 2017) and **cell-phone Raman field identification** (Dhankhar & Wehner 2023). The instrument:
...
1. **Validate with Matthew** on a ground-truthed multi-element section (co-authored).
