...
|---|---|---|---|
| **#57** | _(HOLD, prepared 2026-05-20)_ | _(queued)_ | **🎤 Talk deck compression — 22 → 10 slides.** The 10-slide compressed final-talk deck (`CodaWork2026_FinalTalk_10Slide_2026-05-20.{pptx,pdf}`) becomes the conference talk. Drops MC-4 slide and "Inspect the instrument" closer; contact moves onto slide 1. ~8 min spoken; case-study slides 6/7/8 weighted at 75 sec each. 12-slide and 22-slide variants preserved as siblings. New `SPEAKING_SCRIPT_10slide.md` with beat-by-beat verbal direction. README chain refreshed (`CODA-Association/`, `CODAwork2026/`, `data_outputs/`). `CONFERENCE_ATTENDEES.md` slide-by-slide block rewritten from 22 → 10 slides with manuscript links preserved. `VERSION_HISTORY.md` entry for 2026-05-20. Peter's directive: *"breathing room and time to talk… make this all seamless, simplify and make sense not confusion."* Lockdown-compliant S2 doc-only. |
