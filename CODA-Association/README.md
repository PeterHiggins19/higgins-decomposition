...
└── CODAwork2026/                             ← conference (June 2026)
    ...
    │   ├── CodaWork2026_Presentation_2026-05-28.pdf   ← THE TALK (single grayscale PDF, 21 slides; 16:9 widescreen; PDF-only as of 2026-05-28) — START HERE
...
1. **`CodaWork2026_Presentation_2026-05-28.pdf`** — **the single grayscale PDF, 21 slides, 16:9 widescreen** (numbered N / 21, ~14 min spoken): the talk → the rest-of-world finale → the live-projector close, one file. White background, black text, hatched (value + pattern) size-view and Power-Share figures. Pure-science terminology: named on its subject, **deceptive drift**, defined on the slide where it first appears. **PDF-only delivery** as of 2026-05-28 per Peter's directive ("*the PowerPoint can be archived and no more PowerPoint, only pdf*"); layout rebuilt to fully use the expanded canvas (figures up to 10.20 in wide; fonts +20 % for distance reading). Side-by-side speech + Q&A bench: [`CODAwork2026/SPEAKING_SCRIPT_QA_companion.md`](CODAwork2026/SPEAKING_SCRIPT_QA_companion.md) / [`.pdf`](CODAwork2026/SPEAKING_SCRIPT_QA_companion.pdf). The prior PPTX + PDF (2026-05-27 layout) archived at [`CODAwork2026/archive/talk_decks_pre_pdfonly_2026-05-28/`](CODAwork2026/archive/talk_decks_pre_pdfonly_2026-05-28/); the 13-slide colour predecessor + scripts at [`CODAwork2026/archive/talk_decks_pre_presentation_2026-05-27/`](CODAwork2026/archive/talk_decks_pre_presentation_2026-05-27/); earlier stages at [`.../talk_decks_pre_13slide_2026-05-24/`](CODAwork2026/archive/talk_decks_pre_13slide_2026-05-24/) and [`.../talk_decks_pre_10slide_2026-05-20/`](CODAwork2026/archive/talk_decks_pre_10slide_2026-05-20/). All preserved for lineage, not for use.
