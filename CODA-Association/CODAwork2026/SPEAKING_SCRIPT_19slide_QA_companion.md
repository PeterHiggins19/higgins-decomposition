---
title: "Speaking Script + Q&A Bench — 19-slide grayscale talk"
subtitle: "CoDaWork 2026 · Coimbra, Portugal · 1–5 June 2026"
author: "Peter Higgins · Rogue Wave Audio / Binaural Test Lab"
date: "2026-05-27"
---

# Speaking Script + Q&A Bench — 19-slide grayscale talk

**Deck:** `CodaWork2026_Presentation_2026-05-27.pptx` — single grayscale file, **19 slides**, every slide numbered N / 19.

**Narrative (clinical order):** standard CoDa → how we add **time** to the simplex (the five named readings) → three highlighted countries → **the rest of the world** (the other six) → the live instrument closes the show.

**Timing:** ~13 min spoken across 19 slides (the rest-of-world finale is a brisk sweep) · +~1 min live HTML close = **~14 min** · then **5 min Q&A**.
...
**Voice notes:** No preamble. Periods, not commas. Numbers first, qualifier after. Slow on the three case studies (slides 6–11). The rest-of-world finale (13–18) is a sweep — one breath per country, do not dwell. End on slide 19 and open the projector.
...
**A:** ~13 minutes across 19 slides, then ~1 minute on the live projector — about 14 minutes — then 5 minutes of Q&A.
...
## Slide 6 · Germany — share and work   ·   60 sec
...
## Slide 8 · Japan — share and work   ·   60 sec
...
## Slide 9 · Japan — the trajectory   ·   40 sec
...
## Slide 10 · United Kingdom — share and work   ·   60 sec
...
## Slide 11 · United Kingdom — the trajectory   ·   40 sec
...
## Slide 12 · Across the corpus — deceptive drift in 5 of 9   ·   55 sec
...
## Slides 13–18 · The rest of the world — the other six   ·   ~2 min 15 sec total (one breath each)
...
**13 · Australia (deceptive drift present).** Same protocol, the rest of the world. Australia — the full trajectory; the deceptive-drift signature, structural work concentrated in the renewable turn.

**14 · China (deceptive drift present).** China — coal-era growth, then a turn. The flips pile up; small carriers absorb structural work over and over.

**15 · India (deceptive drift present).** India — the third case where it is present. The same concentration signature, a different grid.

**16 · France (absent).** Now the three with no deceptive drift. France — nuclear-stable across the whole window. The trajectory barely moves; the detector correctly stays silent.

**17 · United States (absent).** The United States — a large grid; no deceptive drift at annual grain. Real moments exist within years; the annual view averages them out.

**18 · World (absent).** And the world aggregate. Large-N smoothing hides the deceptive drift in its constituents — the corpus average is calmer than any country in it.
...
## Slide 19 · What the stack answers — the live instrument closes   ·   45 sec + ~1 min live
...
<td>HUF AI Collective protocol per HUF-STD-001 v1.1. Claude, ChatGPT, Grok for drafting, review, cross-check, code sweeps. Author byline is human-only; I retain full scientific responsibility. Declaration on slide 19.</td>
</tr>
<tr>
...
| **Case studies (6–11)** | Slow there. The cases pay off. On the trajectory slides (7, 9, 11) let the chart breathe — ~40 seconds. |
| **Rest-of-world finale (13–18)** | A sweep, not six talks. One breath per country. Say the prompt and move. ~20 seconds each. |
...
- **The deck is one grayscale file** — 19 slides, every slide numbered N / 19. White background, black text, grayscale charts: prints cheaply, reads at a distance.
- **The rest-of-world finale (slides 13–18)** is in the flow, not an appendix — six clean trajectories (deceptive drift present: AUS · CHN · IND; absent: FRA · USA · WLD), one breath each, then the close.
