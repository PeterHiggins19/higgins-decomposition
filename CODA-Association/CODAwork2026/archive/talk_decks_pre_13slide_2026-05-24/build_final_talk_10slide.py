"""
CoDaWork 2026 — Final Talk Deck builder, COMPRESSED 10-SLIDE VERSION.

Built 2026-05-20 — sharpest possible compression.
Drops MC-4 and Inspect-the-instrument slides; contact moves onto slide 1.
DOES NOT supersede the 22-slide deck — it ships as another sibling.
...
Story arc (10 slides):
  ...
  10. What the stack answers       (synthesis + AI Use footer)

MC-4 falsifiability frame moves to manuscript only.
Cinema scroll / projector run after slide 10 verbally; no dedicated slide.

Total live time target: ~8 min talk + 1.5 min scroll + 1 min projector
                       + ~5 min Q&A buffer = ~15 min.
"""
...
OUT = Path("/sessions/epic-gracious-lovelace/mnt/Claude CoWorker/Current-Repo/Hs/CODA-Association/CODAwork2026/data_outputs/CodaWork2026_FinalTalk_10Slide_2026-05-20.pptx")
...
# AI Use Declaration footer (HUF-STD-001 v1.1 compliance, since slide 12 is gone)
add_text(s,
