...
2. **Slide 21 hands to the live instrument.** Open **`data_outputs/codawork2026_projector.html`** in a browser. Click a country code, then **BARY** for the trajectory, **ALIGN** to flatten it onto the central axis, **SHOCK** to highlight Aitchison-step shocks. Take questions with the manifold live. Runs offline; no network required.
