...
**Deck:** `CodaWork2026_FinalTalk_13Slide_2026-05-24.pptx` · **Total spoken:** ~8 min 50 sec · **Q&A reserve:** ~4 min
...
**Voice notes:** No preamble. Periods, not commas. Numbers first, qualifier after. Slow on the case-study pairs (slides 6–11). On the navigation slides (7, 9, 11) let the chart breathe — 30 seconds is enough.

---

## Slide 1 · Title + question + contact + follow-along + CoDa-tools framing   ·   30 sec
...
**A:** ~9 minutes spoken across 13 slides, plus ~1 min cinema scroll + ~1 min projector demo during Q&A. About 4 minutes for direct Q&A in a 15-minute slot.
...
## Slide 5 · Three archetypes — one instrument, three regimes   ·   20 sec
...
## Slide 12 · Cross-country signature — 5 of 9 reproduce the pattern   ·   60 sec
...
## Slide 13 · What the stack answers — closing synthesis   ·   40 sec
...
<td>"The cinema scroll runs behind us — three hundred and twenty-five pages of the engine's actual output. Pause it anywhere. The handout has the contact and repo on it. Thank you."</td>
</tr>
</table>
...
| **Country pairs (slides 6–11)** | Slow there. The cases pay off. On the navigation slides (7, 9, 11), let the chart breathe — 30 seconds is enough. |
| **Cross-country slide (12)** | Don't summarise the cases. The result speaks for itself. |
| **Close (slide 13)** | End on *"It gives interpretation a reproducible object"* — let it sit. Then transition to Q&A. |
...
- **Cinema scroll** runs as backdrop. 66 slides, 325-page master PDF — every plate the engine produced for the nine-country corpus. Pause anywhere if the questioner wants to dwell.
- **Projector** (`codawork2026_projector.html`) — three modes RADAR / BARY / ALIGN + SHOCK overlay. For "show me a specific country" questions, click JPN → BARY → SHOCK is the canonical sequence (Japan post-Fukushima loop with shock years lit red).
...
*Eight days to Coimbra. Walk to the lectern.*
