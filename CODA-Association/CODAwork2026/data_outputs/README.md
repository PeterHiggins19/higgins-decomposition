...
[`CodaWork2026_Presentation_2026-05-28.pdf`](CodaWork2026_Presentation_2026-05-28.pdf) — **21 slides, 16:9 widescreen, ~3.3 MB** (PDF-only as of 2026-05-28; the previous PPTX has been archived per Peter's 2026-05-28 directive — *"the PowerPoint can be archived and no more PowerPoint, only pdf"*). Figures and fonts in this version use the expanded canvas (margins 0.4 in, content 10.2 in × 7.65 in; share-and-work figures and method diagram up to 10.20 in wide; world-plate and Germany-plate trajectories 9.50 in; fonts +20 % for distance reading)
...
**Timing:** ~14 min spoken across the 21 slides + ~1 min live close (30 sec CN-TT Output PDF flash-through + 30 sec HTML projector) = ~15 min, then 5 min Q&A.
...
**Piece 2 — the CN-TT Output (full-corpus raw-data provenance reference).**
[`CodaWork2026_CN-TT_Output_2026-05-28.pdf`](CodaWork2026_CN-TT_Output_2026-05-28.pdf) — 325-page master PDF, 3.7 MB (public-face artifact, renamed 2026-05-28 from PremierDataOutput to align with HUF-STD-002 Tensor Train I/O Standard nomenclature: CN-TT = CNT / Tensor Train)
[`CodaWork2026_PremierDataOutput_2026-05-13.pptx`](CodaWork2026_PremierDataOutput_2026-05-13.pptx) — 66-slide editing source, 6.3 MB (kept under original name as the editable PPTX source)
[`CodaWork2026_PremierDataOutput_2026-05-13.pdf`](CodaWork2026_PremierDataOutput_2026-05-13.pdf) — prior-name PDF, byte-identical content to CN-TT_Output_2026-05-28.pdf; superseded as the public-face artifact but kept in place for now
Master cover + 9 country sections × 6 plates each (cover · Stage 1 Section · trajectory plot · helmsman · ILR-Helmert Triplet · CNQ dashboard). Hash-chained to the input CSVs. **This is the raw-data provenance for every claim in the Presentation** — every slide in the talk traces back to a plate here. Manual plate-by-plate verification is a HUF-system requirement; this is the artifact where a reviewer performs it. **The talk's close flashes through this PDF for ~30 sec** (the Stage 1 plate sequence rendered movie-like, showing the data points move on the simplex frame-by-frame) before handing to the live HTML projector. The six non-case-study countries already appear in the Presentation's rest-of-world finale; the CN-TT Output is the complete output for any Q&A that reaches past the trajectories. Pause anywhere.

**Piece 3 — the closing projector (live) — v2.2.**
[`codawork2026_projector.html`](codawork2026_projector.html) — interactive 3-D manifold projector, runs offline in a browser. **Three projection modes** (RADAR / BARY / ALIGN) plus an Aitchison-step **SHOCK** overlay. Consumes engine v3.2.0 ILR-Helmert PCA barycenter coordinates so BARY and ALIGN match the manuscript's Fig 6 navigation chart exactly. Slide 21 of the Presentation hands first to the CN-TT Output PDF (30 sec flash-through, raw-data provenance, movie-like) and then to this projector (30 sec live, audience-driven country pick). A live PROJECTION info panel (top-left, toggleable) shows the math being applied. See "The projector — engine v3.2.0 ILR-Helmert PCA" below for full detail.

## How to run the presentation

1. Open `CodaWork2026_Presentation_2026-05-28.pdf` full-screen in any PDF viewer (Acrobat / Preview / Edge / Chrome). Walk the 21-slide arc using [`../SPEAKING_SCRIPT_QA_companion.md`](../SPEAKING_SCRIPT_QA_companion.md) for timing (≈ 14 min spoken; slides 6–13 are the three country pairs — share-and-structural-work view then trajectory — with Germany also carrying two complete-set plates, 8–9; slides 15–20 are the rest-of-world finale, one breath each).
2. **Slide 21 hands to the live close — two artifacts, ~30 sec each.** First, open `CodaWork2026_CN-TT_Output_2026-05-28.pdf` and flash through the Stage 1 plates page-by-page at ~1 sec / page — the data points move on the simplex frame-by-frame, showing the raw-data provenance of every claim in the talk. Then open `codawork2026_projector.html` in a browser (Chrome / Firefox / Safari all work; no network required). Click a country code, then **BARY** for the trajectory, **ALIGN** for the centred view, **SHOCK** to highlight Aitchison-step shocks. Take questions with the manifold live (~5 min Q&A).
3. For any Q&A question that reaches past the trajectories, `CodaWork2026_CN-TT_Output_2026-05-28.pdf` (and its editing source `CodaWork2026_PremierDataOutput_2026-05-13.pptx`) holds the complete engine output — all 27 plates per country + Stage 2/3 + CNQ for all nine countries. Manual plate-by-plate verification — a HUF-system requirement — is done from this artifact.
...
- The **21-slide grayscale PDF Presentation, 16:9 widescreen** (`CodaWork2026_Presentation_2026-05-28.pdf`) is the active conference deck. It was reached through six stages: the 22-slide narrative (2026-05-17) → 12-slide intermediate (2026-05-20 morning) → 10-slide compressed (2026-05-20 afternoon) → 13-slide expansion (2026-05-24) → single grayscale 21-slide Presentation in PPTX + PDF (2026-05-27: one file with the rest-of-world finale + live-projector close, deceptive-drift terminology, hatched grayscale figures, per-slide numbering) → **PDF-only with expanded layout (2026-05-28)** per Peter's directive *"the PowerPoint can be archived and no more PowerPoint, only pdf — regenerate to utilize the expanded width real estate"* (canvas same 16:9 widescreen; margins tightened 0.5 → 0.4 in; figure widths bumped to 9.5–10.20 in; fonts +20 % for distance reading; the prior PPTX + PDF archived at [`../archive/talk_decks_pre_pdfonly_2026-05-28/`](../archive/talk_decks_pre_pdfonly_2026-05-28/)). The 13-slide colour predecessor + scripts live at [`../archive/talk_decks_pre_presentation_2026-05-27/`](../archive/talk_decks_pre_presentation_2026-05-27/); the 10-slide at [`../archive/talk_decks_pre_13slide_2026-05-24/`](../archive/talk_decks_pre_13slide_2026-05-24/); the 22-slide and 12-slide stages at [`../archive/talk_decks_pre_10slide_2026-05-20/`](../archive/talk_decks_pre_10slide_2026-05-20/).
