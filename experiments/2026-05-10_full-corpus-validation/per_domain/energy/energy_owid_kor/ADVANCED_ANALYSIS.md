# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_kor
...
**cnq_content_sha256:** `81204b278346ff2e6d0b1c3b78c932d67c9e748f201108c5641dd9bf337e6542`
...
| Amplitude A | 1.8067 | Cycle amplitude |
| Damping ζ | +0.0045 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 29 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.3696 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.4681 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0090 to 0.2735 rad |
| Bearing angle mean | 0.0763 rad |
| Bearing pairs tested | 47 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.1982 |
| Captured step fraction (global) | 0.5388 |
| CHSH S | 0.4681 |
