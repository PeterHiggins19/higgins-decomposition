# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_ind
...
**cnq_content_sha256:** `5b18cdfd390bcd8cfa94d8974440aade442d8989c9da1452e280131234d19805`
...
| Amplitude A | 2.0083 | Cycle amplitude |
| Damping ζ | +0.0047 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0030 to 0.4888 rad |
| Bearing angle mean | 0.0381 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3597 |
| Captured step fraction (global) | 0.4478 |
| CHSH S | 0.0339 |
