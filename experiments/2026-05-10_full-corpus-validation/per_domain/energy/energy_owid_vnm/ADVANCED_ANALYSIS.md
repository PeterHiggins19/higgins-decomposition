# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_vnm
...
**cnq_content_sha256:** `aee3a66337a5e332af4645ec1f01a917600ec95748374c769fa0ce7bb19bb861`
...
| Amplitude A | 3.1980 | Cycle amplitude |
| Damping ζ | -0.0109 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 26 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.3810 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.7907 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0022 to 0.0963 rad |
| Bearing angle mean | 0.0247 rad |
| Bearing pairs tested | 43 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.4508 |
| Captured step fraction (global) | 0.0922 |
| CHSH S | 0.7907 |
