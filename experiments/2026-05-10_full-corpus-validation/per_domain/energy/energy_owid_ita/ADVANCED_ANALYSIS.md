# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_ita
...
**cnq_content_sha256:** `170ed3a9fb94de3f31b7e639fd39a94914a34723260cd9c327d8d32c31696ae6`
...
| Amplitude A | 0.9462 | Cycle amplitude |
| Damping ζ | +0.0065 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 28 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.5172 | Global trend persistence (1 = monotone, 0 = pure noise) |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0023 to 0.2700 rad |
| Bearing angle mean | 0.0274 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3548 |
| Captured step fraction (global) | 0.3561 |
| CHSH S | 0.1017 |
