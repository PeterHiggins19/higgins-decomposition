# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_sgp
...
**cnq_content_sha256:** `a47ee5bf66efc1bc1b342bcfcbe328004bdf630ffcfc4c2df49a12861c0f9270`
...
| Amplitude A | 1.8380 | Cycle amplitude |
...
| Helmsman stability S_σ | 0.4667 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.2500 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0020 to 0.1894 rad |
| Bearing angle mean | 0.0370 rad |
| Bearing pairs tested | 16 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3168 |
| Captured step fraction (global) | 0.5425 |
| CHSH S | 0.2500 |
...
| Oil | Nuclear | +0.9997 | 11.0° | no |
| Oil | Hydro | +0.9997 | 11.0° | no |
