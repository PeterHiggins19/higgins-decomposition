# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_aut
...
**cnq_content_sha256:** `ab055f8f3421f1f189ca55ee658f1f9d5ee6a2e26616f0d5f56b0b9e6ccc1fe4`
...
| Amplitude A | 0.1552 | Cycle amplitude |
| Damping ζ | +0.0179 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0007 to 0.0193 rad |
| Bearing angle mean | 0.0072 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2890 |
| Captured step fraction (global) | 0.0078 |
| CHSH S | 0.1017 |
...
| Gas | Hydro | +0.9911 | 6.0° | YES |
| Gas | Nuclear | +0.9900 | 32.5° | no |
| Gas | Oil | +0.9893 | 5.0° | YES |
