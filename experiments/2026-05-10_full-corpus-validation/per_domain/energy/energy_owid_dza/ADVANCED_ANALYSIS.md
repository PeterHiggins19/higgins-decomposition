# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_dza
...
**cnq_content_sha256:** `8e2846374d16e3990ffec0a2108a6fbeffbef515c68c760bcfbd022c16a87fc7`
...
| Amplitude A | 0.7867 | Cycle amplitude |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0009 to 0.2274 rad |
| Bearing angle mean | 0.0310 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2826 |
| Captured step fraction (global) | 0.2289 |
| CHSH S | 0.6441 |
