# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_cze
...
**cnq_content_sha256:** `fc6aaeebc062f8eb18761f2a3b4e1e206fd8e451c29eccee2d1f7850475c9218`
...
| Amplitude A | 1.5362 | Cycle amplitude |
| Damping ζ | +0.0118 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0011 to 0.4067 rad |
| Bearing angle mean | 0.0781 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2559 |
| Captured step fraction (global) | 0.4104 |
| CHSH S | 0.0339 |
...
| Gas | Hydro | +0.8948 | 94.7° | no |
| Gas | Wind | -0.8270 | 20.9° | no |
| Solar | Wind | +0.8130 | 51.5° | no |
