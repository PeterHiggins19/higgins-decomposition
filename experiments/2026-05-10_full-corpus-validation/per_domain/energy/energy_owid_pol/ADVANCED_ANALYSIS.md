# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_pol
...
**cnq_content_sha256:** `3f70d04d8d5e52d76b454e952d7c779ab2a8a8364cf052c469796e964830aa8a`
...
| Amplitude A | 0.5179 | Cycle amplitude |
| Damping ζ | -0.0008 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 21 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.6379 | Global trend persistence (1 = monotone, 0 = pure noise) |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0007 to 0.0208 rad |
| Bearing angle mean | 0.0064 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.1597 |
| Captured step fraction (global) | 0.0083 |
| CHSH S | 0.5763 |
...
| Oil | Nuclear | +0.9850 | 30.4° | no |
| Coal | Oil | +0.9803 | 10.1° | no |
| Gas | Hydro | +0.9742 | 54.9° | no |
