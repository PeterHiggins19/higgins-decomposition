# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_cyp
...
**cnq_content_sha256:** `4c8067560cffacba67a2f6b5c961315606772341ab77328e6d4a90e4e2f04c7e`
...
|---|---|---|
| T (records) | 21 | Trajectory length |
| D (carriers) | 8 | Compositional dimension |
| Termination | `EXHAUSTED` | How the depth tower closed |
| IR class | **`LIGHTLY_DAMPED`** | Imaginary-Radius class — the Hˢ damping signature |
| M²=I residual (max) | 1.388e-17 | Metric involution check; should be at IEEE floor |
| M²=I verified | YES | < 10⁻¹⁰ floor pass |
| Attractor fitted | no | Whether a P2 cycle could be identified |
| Period | — | If fitted, the cycle length |
| Period stability | 0.0000 | 0 = unstable, 1 = locked |
| Amplitude A | 0.5744 | Cycle amplitude |
| Damping ζ | +0.0114 | Sign and magnitude of the dominant-pair damping |
...
| CHSH S | 0.2000 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0022 to 0.2471 rad |
| Bearing angle mean | 0.0599 rad |
| Bearing pairs tested | 20 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.4170 |
| Captured step fraction (global) | 0.2595 |
| CHSH S | 0.2000 |
