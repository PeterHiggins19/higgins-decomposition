# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_irn
...
**cnq_content_sha256:** `7ef53c35c1e7400d85ecabe0bddafa8e416c59957a230bbb728e8e81c2b5a3cd`
...
| Amplitude A | 1.4762 | Cycle amplitude |
| Damping ζ | -0.0170 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0024 to 0.2653 rad |
| Bearing angle mean | 0.0344 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.4909 |
| Captured step fraction (global) | 0.4265 |
| CHSH S | 0.0339 |
