# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_nld
...
**cnq_content_sha256:** `a8c936fe51d52b23af191052e2529f21a20c198d79093b6a8a55553376ac8359`
...
|---|---|---|
| T (records) | 57 | Trajectory length |
...
| Amplitude A | 0.7304 | Cycle amplitude |
| Damping ζ | +0.0326 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 34 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.3818 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.1429 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0049 to 0.1538 rad |
| Bearing angle mean | 0.0421 rad |
| Bearing pairs tested | 56 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3218 |
| Captured step fraction (global) | 0.1096 |
| CHSH S | 0.1429 |
