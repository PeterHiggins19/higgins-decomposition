# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_nzl
...
**cnq_content_sha256:** `8821f4334115cca32f7361893770d7f0998bb1c75b0a8e315a3b4cdfe0111b2f`
...
| Amplitude A | 0.2831 | Cycle amplitude |
| Damping ζ | +0.0103 | Sign and magnitude of the dominant-pair damping |
...
| CHSH S | 0.2963 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0010 to 0.0779 rad |
| Bearing angle mean | 0.0173 rad |
| Bearing pairs tested | 54 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.4393 |
| Captured step fraction (global) | 0.0722 |
| CHSH S | 0.2963 |
