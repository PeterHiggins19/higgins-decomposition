# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_bgd
...
**cnq_content_sha256:** `794b1f55560eae96abeb7f57f8c35385a032e3f4fd0277fa1f02384bbacb54a1`
...
| Amplitude A | 0.7293 | Cycle amplitude |
| Damping ζ | +0.0149 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 30 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.4231 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.7925 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0034 to 0.1794 rad |
| Bearing angle mean | 0.0356 rad |
| Bearing pairs tested | 53 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.4598 |
| Captured step fraction (global) | 0.3627 |
| CHSH S | 0.7925 |
