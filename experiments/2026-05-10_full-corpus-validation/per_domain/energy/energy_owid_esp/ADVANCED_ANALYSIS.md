# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_esp
...
**cnq_content_sha256:** `0dadf027adc18a09195ba90801bae7f0d851dabcfe8ffb744ed9e748a882c1ab`
...
| Amplitude A | 1.7677 | Cycle amplitude |
| Damping ζ | -0.0018 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0177 to 0.3566 rad |
| Bearing angle mean | 0.1030 rad |
| Bearing pairs tested | 56 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3169 |
| Captured step fraction (global) | 0.3111 |
| CHSH S | 0.5000 |
