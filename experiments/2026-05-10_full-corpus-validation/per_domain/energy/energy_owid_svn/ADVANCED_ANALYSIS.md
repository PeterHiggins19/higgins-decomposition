# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_svn
...
**cnq_content_sha256:** `901a93bb12241f5cf78def9fd2e586358843fff61d6e50655595365ec9608899`
...
| Amplitude A | 0.1966 | Cycle amplitude |
| Damping ζ | -0.0258 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 20 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.3939 | Global trend persistence (1 = monotone, 0 = pure noise) |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0163 to 0.3127 rad |
| Bearing angle mean | 0.1071 rad |
| Bearing pairs tested | 34 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2380 |
| Captured step fraction (global) | 0.0070 |
| CHSH S | 0.3529 |
...
| Nuclear | Hydro | +0.9938 | 11.9° | no |
| Coal | Oil | +0.9937 | 20.1° | no |
| Gas | Hydro | +0.9923 | 16.9° | no |
