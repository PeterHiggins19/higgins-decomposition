# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_ecu
...
**cnq_content_sha256:** `f8c053be4aa8f6491d96cc7f00fd59847984c3a859ec4e67fe32a2bd98b64c94`
...
| Amplitude A | 1.1401 | Cycle amplitude |
| Damping ζ | +0.0204 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 19 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.4242 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 1.1765 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0034 to 0.3493 rad |
| Bearing angle mean | 0.0705 rad |
| Bearing pairs tested | 34 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.5560 |
| Captured step fraction (global) | 0.4097 |
| CHSH S | 1.1765 |
