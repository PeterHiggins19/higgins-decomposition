# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_irl
...
**cnq_content_sha256:** `036badcd0d3da2df3ed8c20f9404aa35898073aa33fcc6fec831be4e56fd36b1`
...
|---|---|---|
| T (records) | 46 | Trajectory length |
...
| Amplitude A | 0.2958 | Cycle amplitude |
...
| Helmsman stability S_σ | 0.5682 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.5778 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0014 to 0.0911 rad |
| Bearing angle mean | 0.0152 rad |
| Bearing pairs tested | 45 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2401 |
| Captured step fraction (global) | 0.0430 |
| CHSH S | 0.5778 |
...
| Coal | Hydro | +0.9757 | 62.6° | no |
| Coal | Gas | +0.9586 | 44.5° | no |
| Gas | Nuclear | +0.9572 | 29.5° | no |
