# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_mar
...
**cnq_content_sha256:** `bd9dc357db73839830fa074f9fd34e73cf7d464fe5bd42ea417d61625aa7c493`
...
| Amplitude A | 3.2263 | Cycle amplitude |
| Damping ζ | -0.0120 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0025 to 0.1467 rad |
| Bearing angle mean | 0.0217 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3554 |
| Captured step fraction (global) | 0.0783 |
| CHSH S | 0.5085 |
