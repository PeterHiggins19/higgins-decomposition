# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_can
...
**cnq_content_sha256:** `f42735d1afb9549d9b50eafa105e302b247b2156ba9b1a9d9723c9b21daa658e`
...
| Amplitude A | 1.3212 | Cycle amplitude |
| Damping ζ | +0.0073 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0032 to 0.1702 rad |
| Bearing angle mean | 0.0514 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.4357 |
| Captured step fraction (global) | 0.1036 |
| CHSH S | 0.0339 |
