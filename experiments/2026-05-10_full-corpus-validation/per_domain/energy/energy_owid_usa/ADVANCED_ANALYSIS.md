# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_usa
...
**cnq_content_sha256:** `dbb6be85be1e42cf24ccdf00f6ddd38054ee086d50ffd0cf5129e92987605fcd`
...
| Amplitude A | 0.3807 | Cycle amplitude |
| Damping ζ | +0.0057 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0063 to 0.1186 rad |
| Bearing angle mean | 0.0378 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2664 |
| Captured step fraction (global) | 0.0199 |
| CHSH S | 0.2373 |
