# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_lux
...
**cnq_content_sha256:** `cf954c7f0910ee6c1217e0652e6632658964c09cdc6641ddb2bc98e4ddf6e63e`
...
| Amplitude A | 0.5097 | Cycle amplitude |
| Damping ζ | +0.0077 | Sign and magnitude of the dominant-pair damping |
| Helmsman flips | 37 | Dominant-axis transitions across the trajectory |
| Helmsman stability S_σ | 0.3148 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.0364 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0015 to 0.1667 rad |
| Bearing angle mean | 0.0205 rad |
| Bearing pairs tested | 55 |
| Bearing max residual | 3.33e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3055 |
| Captured step fraction (global) | 0.0563 |
| CHSH S | 0.0364 |
