# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_gbr
...
**cnq_content_sha256:** `2aae7673e23e1acf8c68bed668dbb3c28b0e0d94c25439de4e75fc7f409a0731`
...
| Amplitude A | 0.5218 | Cycle amplitude |
| Damping ζ | -0.0040 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0066 to 0.3508 rad |
| Bearing angle mean | 0.0804 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 4.44e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3581 |
| Captured step fraction (global) | 0.0695 |
| CHSH S | 0.3051 |
