# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_kaz
...
**cnq_content_sha256:** `75889f72509cc18ca009253d1b3d4a149a6af394ab6236e6580ee2bd50f04ab6`
...
| Amplitude A | 2.4713 | Cycle amplitude |
| Damping ζ | +0.0203 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0012 to 0.1034 rad |
| Bearing angle mean | 0.0239 rad |
| Bearing pairs tested | 39 |
| Bearing max residual | 4.44e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3913 |
| Captured step fraction (global) | 0.7331 |
| CHSH S | 0.0513 |
...
| Coal | Gas | +0.9657 | 4.6° | YES |
| Gas | Oil | +0.9600 | 5.8° | YES |
| Coal | Hydro | +0.9462 | 12.9° | no |
