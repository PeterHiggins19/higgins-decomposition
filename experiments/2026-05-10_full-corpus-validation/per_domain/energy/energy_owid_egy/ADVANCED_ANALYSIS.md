# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_egy
...
**cnq_content_sha256:** `7f5cde5047db8ed3c7620fea0dce0a5886e7bf341d780d9d9be45579abd444dd`
...
| M²=I residual (max) | 6.939e-18 | Metric involution check; should be at IEEE floor |
| M²=I verified | YES | < 10⁻¹⁰ floor pass |
| Attractor fitted | no | Whether a P2 cycle could be identified |
| Period | — | If fitted, the cycle length |
| Period stability | 0.0000 | 0 = unstable, 1 = locked |
| Amplitude A | 0.7070 | Cycle amplitude |
...
| Helmsman stability S_σ | 0.5862 | Global trend persistence (1 = monotone, 0 = pure noise) |
| CHSH S | 0.6441 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0021 to 0.1634 rad |
| Bearing angle mean | 0.0223 rad |
| Bearing pairs tested | 59 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.5316 |
| Captured step fraction (global) | 0.1216 |
| CHSH S | 0.6441 |
...
| Nuclear | Hydro | +0.9762 | 33.5° | no |
| Coal | Hydro | +0.9577 | 27.7° | no |
| Coal | Oil | +0.9570 | 25.8° | no |
