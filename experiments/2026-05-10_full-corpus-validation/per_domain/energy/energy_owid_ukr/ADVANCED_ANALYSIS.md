# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_ukr
...
**cnq_content_sha256:** `b686802b3005c961d680305609cabf269459c787b905c26ab3abc1cee838029b`
...
| Amplitude A | 0.3968 | Cycle amplitude |
| Damping ζ | +0.0038 | Sign and magnitude of the dominant-pair damping |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0043 to 0.7678 rad |
| Bearing angle mean | 0.1229 rad |
| Bearing pairs tested | 39 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.2505 |
| Captured step fraction (global) | 0.0218 |
| CHSH S | 0.0513 |
