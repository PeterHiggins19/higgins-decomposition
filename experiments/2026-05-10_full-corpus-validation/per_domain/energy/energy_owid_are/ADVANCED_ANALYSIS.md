# Advanced Analysis (Hˢ + CNQ v2) — energy_owid_are
...
**cnq_content_sha256:** `b2a6e5a041f309ee905b7ec581629e85ab0334526f2c1f5922d8f19e3cea998f`
...
|---|---|---|
| T (records) | 16 | Trajectory length |
...
| Amplitude A | 1.4039 | Cycle amplitude |
| Damping ζ | -0.1109 | Sign and magnitude of the dominant-pair damping |
...
| CHSH S | 0.1333 | Joint-coherence diagnostic; classical bound 2.0, Tsirelson 2√2 |
...
| D | 8 |
| Branch | `—` |
| Bearing angle range | 0.0057 to 0.3911 rad |
| Bearing angle mean | 0.0868 rad |
| Bearing pairs tested | 15 |
| Bearing max residual | 2.22e-16 |
| Bearing gate pass | YES |
| Captured step fraction (mean) | 0.3311 |
| Captured step fraction (global) | 0.6014 |
| CHSH S | 0.1333 |
