...
If your data is **not** compositional — raw signals, or absolute counts with no shared whole — Hˢ may not be the right tool, and it will tell you so honestly (and can still give you a standard static picture if that's all that fits). **An AI assistant can confirm the fit in one look at your data** before you invest any effort.
...
| **up to D = 1,000,000** | proven — the tree‑atlas reconstructs a million parts at the IEEE floor. High complexity is the design point, not the limit. |
