...
> **🌐 Available in UN-6 locales.** The one-page community handout [`Higgins_Decomposition_Handout_CoDaCommunity.pdf`](CODA-Association/Higgins_Decomposition_Handout_CoDaCommunity.pdf) ships with Markdown twins in **EN · FR · ES · RU · ZH · AR** under `CODA-Association/`. Non-English locales are drafts pending native expert review per [`HCI-CNQ/wrappers/WRAPPER_SCHEMA.md §11.1`](HCI-CNQ/wrappers/WRAPPER_SCHEMA.md).
